<template>
    <div class="addTest">
        ...
        <div class="addTest-main">
            ...
            <span>题目主题</span>
            <EditorBar v-model="editor.info" :content="parameter.questions_stem" @editorContent="getQuestions_stem"></EditorBar>
            <span>请选择考试类型：</span>
            <el-form-item label="">
            ...
            <EditorBar :content="parameter.questions_stem" @editorContent="getQuestions_answer_stem"></EditorBar>
