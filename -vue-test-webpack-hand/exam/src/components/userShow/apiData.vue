<template>
    <div class="show1">
        <h1>api接口权限</h1>
        <el-table
                :data="apiData.slice((this.currentPage-1)*this.currentSize,this.currentPage*this.currentSize)"
                height="600"
...
export default {
    ...
    methods:{
        ...
        console.log(this.currentSize)
            ...
            this.pageList=this.apiData.slice((this.currentPage-1)*this.currentSize,this.currentPage*this.currentSize);
